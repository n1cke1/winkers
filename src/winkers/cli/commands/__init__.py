...
from winkers.cli.commands.conventions import cleanup_legacy, conventions_migrate
from winkers.cli.commands.couplings import couplings
...
from winkers.cli.commands.dupes import dupes_cmd
from winkers.cli.commands.git_cmds import autocommit, commit_fmt, commits_normalize, hooks_install
from winkers.cli.commands.impact import impact_cmd
...
from winkers.cli.commands.search import search
...
def register_commands(cli: click.Group) -> None:
    ...
    cli.add_command(conventions_migrate)
    cli.add_command(cleanup_legacy)
